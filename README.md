...
A 12-chapter implementation-level textbook covering wire formats, protobuf
definitions, handshake sequences, and byte-level structures for every
component is maintained separately in the author's notes repository.
