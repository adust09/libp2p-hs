...
module LibP2P.Crypto.SignedEnvelope
  ( SignedEnvelope (..)
  , createEnvelope
  , verifyEnvelope
...
import LibP2P.Crypto.Key (PublicKey (..), PrivateKey, sign, verify)
import LibP2P.Crypto.Protobuf (encodePublicKey, decodePublicKey)
